...
$inset-shadow: inset 0 -1px 1px rgba(var(--d-body-color-rgb), 0.15),0 0.25rem 1.5rem rgba(var(--d-body-bg-rgb), 0.75);
...
<div class:demoHidden="{current === 1}" class="new-f"  data-m="bounce-down">
  ...
  <video on:ended="{showReplay}" bind:this="{newFDemo}" class="new-f-demo lazyload" controlsList="nodownload" playsinline autoplay muted poster="/iphones.webp">
...
<main style="position: relative; top: 0;">
    ...
    <div class="container-sm">
      <div class="col">
        <div class="row">
          <h1 class="big-heading mb-3 fw-semibold lh-1">The most <span class="h1-switch">customizable</span> c&zwnj;h&zwnj;att&zwnj;ing service out there</h1>
        ...
        <div class="row">
          ...
          <h1><code style="font-family: var(--d-font-monospace)!important;" class="encryption mb-3 fw-semibold lh-1 text-center text-black">End to end encryption</code></h1>
    ...
    <footer class="py-5 container footer bg-body-tertiary">
      <div class="row">
        <div class="col-lg-3 mb-3">
          <h2 style="font-family: 'Outfit'; " class="icon-link"><img alt="Logo" style="height: 48px;" src="/icons/android-chrome-192x192.png">Dispatch</h2>
          <p class="text-muted"><!--Find us on <a target="_blank" href="https://github.com/GoneRogueProductions/dispatchx" >Github</a>.
            <br>-->
            Code license <a target="_blank" href="https://github.com/GoneRogueProductions/dispatchx/blob/main/LICENSE">MPL</a>, docs <a href="http://creativecommons.org/licenses/by/4.0/?ref=chooser-v1" target="_blank" rel="license noopener noreferrer">CC BY 4.0</a>, media  <a href="http://creativecommons.org/licenses/by-nc/4.0/?ref=chooser-v1" target="_blank" rel="license noopener noreferrer">CC BY-NC 4.0</a>. 
          </p>
        </div>
        ...
        <div class="col mb-3">
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2"><a href="/authenticate" class="nav-link p-0 text-muted">Log in</a></li>
            <li class="nav-item mb-2"><a href="/authenticate?state=reg" class="nav-link p-0 text-muted">Sign up</a></li>
        ...
        <div class="col mb-3">
          <h5>Contribute</h5>
          <ul class="nav flex-column">
            <li class="nav-item mb-2"><a target="_blank" href="https://github.com/GoneRogueProductions/dispatchx/" class="nav-link p-0 text-muted">GitHub</a></li>
            <li class="nav-item mb-2"><a target="_blank" href="https://github.com/GoneRogueProductions/dispatchx" class="nav-link p-0 text-muted">Issues</a></li>
            <li class="nav-item mb-2"><a target="_blank" href="https://github.com/GoneRogueProductions/dispatchx" class="nav-link p-0 text-muted">Pull requests</a></li>
            <li class="nav-item mb-2"><a target="_blank" href="https://replit.com/@dispatchx/dispatchx-backend" class="nav-link p-0 text-muted">API</a></li>
          </ul>
        </div>
