<nav class="navbar navbar-expand-lg">
	<div class="container-fluid">
		<a class="navbar-brand" href="/"
			><img alt="Logo" style="height: 48px;" src="/icons/android-chrome-192x192.png" /></a
		>
		<button
...
<style lang="scss">
	...
	@media (min-width: 992px) {
		.navbar .container-fluid .collapse form.d-flex button,
		.navbar .container-sm .collapse form.d-flex button,
		.navbar .container-md .collapse form.d-flex button,
		.navbar .container-lg .collapse form.d-flex button,
		.navbar .container-xl .collapse form.d-flex button,
		.navbar .container-xxl .collapse form.d-flex button {
